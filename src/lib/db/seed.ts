...
const globalExercises = [
  ...
  { id: 'ex-4', name: 'Overhead Shoulder Press', category: 'strength', defaultUnit: 'kg', isGlobal: 1 },
  ...
  { id: 'ex-9', name: 'Tricep Rope Pushdown', category: 'strength', defaultUnit: 'kg', isGlobal: 1 },
  ...
  { id: 'ex-15', name: 'Hamstring Stretch', category: 'mobility', defaultUnit: 'seconds', isGlobal: 1 },
];
